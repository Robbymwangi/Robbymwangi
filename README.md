...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://readme-typing-svg.herokuapp.com?font=Arial&pause=1000&color=F0F6FC&width=650&lines=Hi%2C+Robby+Here+%F0%9F%91%8B;SDE+and+OSS+Contributor">
...
### Main skills
[![My Skills](https://skillicons.dev/icons?i=py,linux,laravel,latex,mongodb,mysql,postgres,supabase,github,git,java,js,ts,nodejs,react,express,py,html,css,bootstrap,php,androidstudio)](https://skillicons.dev)
